...
////    @MethodSource("userInputValueProvider")
//    @Test
//    public void should_return_success_when_user_gave_six_numbers_in_correct_range(String numbers) {
//        // given
//        UserNumbersRetriever userNumbersRetriever =
//                new UserNumbersRetriever(mockScannerIn(numbers));
//        int lowestNumber = 1;
...
//
//        // when
//        NumbersRetrieverResult numbersFromUser = userNumbersRetriever.getNumbersFromUser(
//                howManyNumbers,
//                lowestNumber,
//                maxNumber);
//
